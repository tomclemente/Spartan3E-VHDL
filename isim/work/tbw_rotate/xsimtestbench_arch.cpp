...
#include "isim/SFR/rotate/rotate.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_tbw_rotate_testbench_arch(const char*);
        topvh = createWork_tbw_rotate_testbench_arch("tbw_rotate");
...
main(int argc, char **argv) {
  ...
  try {
    ...
    SfrRotate=new Sfr_rotate("ROTATE");
