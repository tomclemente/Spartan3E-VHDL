...
#include "isim/SFR/shift/shift.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_twb_test_testbench_arch(const char*);
        topvh = createWork_twb_test_testbench_arch("twb_test");
